...
let fecha = prompt("Escribe tu fecha de nacimiento:");
let nombre = prompt("Escribe tu nombre");
let apellido = prompt("Escribe tu apellido");
let n = nombre.charAt(0);
let a = apellido.charAt((apellido.length)-1);
let f = parseInt(fecha.charAt((fecha.length)-1));
document.querySelector("h1").innerHTML = (`${letraNombre[n].masculino} ${letraApellido[a].masculino} ${fechaNacimiento[f].masculino}`)
